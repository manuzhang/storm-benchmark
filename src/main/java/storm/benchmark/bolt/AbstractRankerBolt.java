...
import storm.benchmark.tools.Rankings;
 ...
 * <p/>
 * It uses a template method design pattern for {@link AbstractRankerBolt#execute(backtype.storm.tuple.Tuple, backtype.storm.topology.BasicOutputCollector)} to allow
